...
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  local _755_ = require("fennel.utils")
  local utils = _755_
  local copy = _755_["copy"]
  ...
  local function default_on_error(errtype, err)
    local function _760_()
      local _759_0 = errtype
      if (_759_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _769_()
      local _767_0, _768_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _767_0) and (nil ~= _768_0)) then
        local body = _767_0
        local _return = _768_0
  ...
  local function completer(env, scope, text, _3ffulltext, _from, _to)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_771_()) do
    ...
    do
      local _780_0 = tostring((_3ffulltext or text)):match("^%s*,([^%s()[%]]*)$")
      if (nil ~= _780_0) then
        local cmd_fragment = _780_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _784_0, _785_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_784_0 == true) and (nil ~= _785_0)) then
      ...
      local new = nil
      do
        local _786_0, _787_0 = pcall(require, module_name)
        if ((_786_0 == true) and (nil ~= _787_0)) then
          local new0 = _787_0
          new = new0
        elseif (true and (nil ~= _787_0)) then
          local _1 = _786_0
          local msg = _787_0
          on_error("Repl", msg)
      ...
      return on_values({"ok"})
    elseif ((_784_0 == false) and (nil ~= _785_0)) then
      local msg = _785_0
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _792_()
          local _791_0 = msg:gsub("\n.*", "")
          return _791_0
        end
        return on_error("Runtime", _792_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _795_0, _796_0, _797_0 = pcall(read)
    if ((_795_0 == true) and (_796_0 == true) and (nil ~= _797_0)) then
      local val = _797_0
      local _798_0, _799_0 = pcall(f, val)
      if ((_798_0 == false) and (nil ~= _799_0)) then
        local msg = _799_0
        return on_error("Runtime", msg)
      end
    elseif (_795_0 == false) then
      return on_error("Parse", "Couldn't parse input.")
    end
  end
  commands.reload = function(env, read, on_values, on_error)
    local function _802_(_241)
      return reload(tostring(_241), env, on_values, on_error)
    end
    return run_command(read, on_error, _802_)
  end
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _804_0 = type(subtbl)
        if (_804_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_804_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _806_, names)
          end
        end
      end
    end
  ...
  commands.apropos = function(_env, read, on_values, on_error, _scope)
    ...
    return run_command(read, on_error, _810_)
  end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _814_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _814_0) then
            local docstr = _814_0
  ...
  commands["apropos-doc"] = function(_env, read, on_values, on_error, _scope)
    ...
    return run_command(read, on_error, _818_)
  end
  ...
  commands["apropos-show-docs"] = function(_env, read, on_values, on_error)
    local function _820_(_241)
      return apropos_show_docs(on_values, tostring(_241))
    end
    return run_command(read, on_error, _820_)
  end
  ...
  local function resolve(identifier, _821_0, scope)
    local _822_ = _821_0
    local env = _822_
    local ___replLocals___ = _822_["___replLocals___"]
    local e = nil
    local function _823_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _823_})
    local function _824_(...)
      local _825_0, _826_0 = ...
      if ((_825_0 == true) and (nil ~= _826_0)) then
        local code = _826_0
        local function _827_(...)
          local _828_0, _829_0 = ...
          if ((_828_0 == true) and (nil ~= _829_0)) then
            local val = _829_0
            return val
          else
            local _ = _828_0
        ...
        return _827_(pcall(specials["load-code"](code, e)))
      else
        local _ = _825_0
        return nil
      end
    end
    return _824_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _832_(_241)
      local _833_0 = nil
      do
        local _834_0 = utils["sym?"](_241)
        if (nil ~= _834_0) then
          local _835_0 = resolve(_834_0, env, scope)
          if (nil ~= _835_0) then
            _833_0 = debug.getinfo(_835_0)
          else
            _833_0 = _835_0
          end
        else
      ...
      local function _838_()
        local line = _833_0.linedefined
        local source = _833_0.source
        return (("string" == type(source)) and ("@" == source:sub(1, 1)))
      end
      if (((_G.type(_833_0) == "table") and (nil ~= _833_0.linedefined) and (nil ~= _833_0.source) and (_833_0.what == "Lua")) and _838_()) then
        local line = _833_0.linedefined
        local source = _833_0.source
        local fnlsrc = nil
        do
          local _839_0 = compiler.sourcemap
          if (nil ~= _839_0) then
            _839_0 = _839_0[source]
          end
          if (nil ~= _839_0) then
            _839_0 = _839_0[line]
          end
    ...
    return run_command(read, on_error, _832_)
  end
  ...
  commands.doc = function(env, read, on_values, on_error, scope)
    ...
    return run_command(read, on_error, _844_)
  end
  ...
  commands.compile = function(_, read, on_values, on_error, _0, _1, opts)
    local function _847_(_241)
      local _848_0, _849_0 = pcall(compiler.compile, _241, opts)
      if ((_848_0 == true) and (nil ~= _849_0)) then
        local result = _849_0
        return on_values({result})
      elseif (true and (nil ~= _849_0)) then
        local _2 = _848_0
        local msg = _849_0
        return on_error("Repl", ("Error compiling expression: " .. msg))
      end
    end
    return run_command(read, on_error, _847_)
  end
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, -1 do
      for name, f in pairs(plugins[i]) do
        local _851_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _851_0) then
          local cmd_name = _851_0
          commands[cmd_name] = f
        end
      end
    end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars, opts)
    ...
    do
      local _853_0 = commands[command_name]
      if (nil ~= _853_0) then
        local command = _853_0
  ...
  local function try_readline_21(opts, ok, readline)
    if ok then
      ...
      opts.readChunk = function(parser_state)
        local _858_0 = readline.readline(prompt_for((0 == parser_state["stack-size"])))
        if (nil ~= _858_0) then
          local input = _858_0
          return (input .. "\n")
        end
  ...
  local function repl(_3foptions)
    ...
    local _862_ = copy(_3foptions)
    local opts = _862_
    local _3ffennelrc = _862_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    local function _864_(_241)
      return callbacks.readChunk(_241)
    end
    byte_stream, clear_stream = parser.granulate(_864_)
    local chars = {}
    local read, reset = nil, nil
    local function _865_(parser_state)
    ...
    read, reset = parser.parser(_865_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _871_()
        local _870_0 = opts.scope
        local function _872_(...)
          return completer(env, _870_0, ...)
        end
        return _872_
      end
      opts.registerCompleter(_871_())
    end
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          local function _876_(...)
            local _877_0, _878_0 = ...
            if ((_877_0 == true) and (nil ~= _878_0)) then
              local src = _878_0
              local function _879_(...)
                local _880_0, _881_0 = ...
                if ((_880_0 == true) and (nil ~= _881_0)) then
                  local chunk = _881_0
                  local function _882_()
                    return print_values(save_value(chunk()))
                  end
                  local function _883_(...)
                    return callbacks.onError("Runtime", ...)
                  end
                  return xpcall(_882_, _883_)
                elseif ((_880_0 == false) and (nil ~= _881_0)) then
                  local msg = _881_0
                  clear_stream()
              ...
              return _879_(_886_(...))
            elseif ((_877_0 == false) and (nil ~= _878_0)) then
              local msg = _878_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            end
          ...
          _876_(pcall(compiler.compile, form, _888_()))
  ...
  repl_mt.__call = function(_894_0, _3fopts)
    local _895_ = _894_0
    local overrides = _895_
    local view_opts = _895_["view-opts"]
    local opts = copy(_3fopts, copy(overrides))
    local _897_
    do
      local _896_0 = _3fopts
      if (nil ~= _896_0) then
        _896_0 = _896_0["view-opts"]
      end
      _897_ = _896_0
    end
    opts["view-opts"] = copy(_897_, copy(view_opts))
    return repl(opts)
  end
  return setmetatable({["view-opts"] = {}}, repl_mt)
end
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  local _526_ = require("fennel.utils")
  local utils = _526_
  local pack = _526_["pack"]
  local unpack = _526_["unpack"]
  local view = require("fennel.view")
  local parser = require("fennel.parser")
  local compiler = require("fennel.compiler")
  ...
  local function wrap_env(env)
    ...
    local function _529_(_, key, value)
      if utils["string?"](key) then
    ...
    local function _531_()
      ...
      do
        ...
        for k, v in utils.stablepairs(env) do
          ...
          if utils["string?"](k) then
            _533_ = compiler["global-unmangling"](k)
          else
            _533_ = k
          end
          k_15_, v_16_ = _533_, v
      ...
      return next, _532_, nil
    end
    return setmetatable({}, {__index = _527_, __newindex = _529_, __pairs = _531_})
  end
  ...
  local function current_global_names(_3fenv)
    local mt = nil
    do
      local _536_0 = getmetatable(_3fenv)
      if ((_G.type(_536_0) == "table") and (nil ~= _536_0.__pairs)) then
        local mtpairs = _536_0.__pairs
        local tbl_14_ = {}
  ...
  local function load_code(code, _3fenv, _3ffilename)
    ...
    local _541_0, _542_0 = rawget(_G, "setfenv"), rawget(_G, "loadstring")
    if ((nil ~= _541_0) and (nil ~= _542_0)) then
      local setfenv = _541_0
      local loadstring = _542_0
  ...
  local function doc_2a(tgt, name)
    ...
    if not tgt then
      ...
      local function _545_()
        local _544_0 = getmetatable(tgt)
        if ((_G.type(_544_0) == "table") and true) then
          local __call = _544_0.__call
          return ("function" == type(__call))
        end
      end
      if ((type(tgt) == "function") or _545_()) then
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _558_ = compiler.compile1(v, scope, chunk, opts)
    local _559_ = _558_[1]
    local v0 = _559_[1]
    return v0
  end
  ...
  local function get_fn_name(ast, scope, fn_name, _3fmulti)
    if (fn_name and (fn_name[1] ~= "nil")) then
      ...
      if not _3fmulti then
        _565_ = compiler["declare-local"](fn_name, scope, ast)
      else
        _565_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _565_, not _3fmulti, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _568_
    if local_3f then
      _568_ = "local function %s(%s)"
    else
      _568_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_568_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  local function get_function_metadata(ast, arg_list, index)
    local function _571_(_241, _242)
      local tbl_14_ = _241
    ...
    local function _573_(_241, _242)
      _241["fnl/docstring"] = _242
      return _241
    end
    return maybe_metadata(ast, utils["kv-table?"], _571_, maybe_metadata(ast, utils["string?"], _573_, {["fnl/arglist"] = arg_list}, index))
  end
  SPECIALS.fn = function(ast, scope, parent)
    local f_scope = nil
    do
      local _574_0 = compiler["make-scope"](scope)
      _574_0["vararg"] = false
      f_scope = _574_0
    end
    local f_chunk = {}
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _580_
    do
      local _579_0 = utils["sym?"](ast[2])
      if (nil ~= _579_0) then
        _580_ = tostring(_579_0)
      else
        _580_ = _579_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local _587_ = compiler.compile1(lhs_node, scope, parent, {nval = 1})
    local lhs = _587_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _588_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _588_[1]
  ...
  SPECIALS.let = function(_595_0, scope, parent, opts)
    local _596_ = _595_0
    local _ = _596_[1]
    local bindings = _596_[2]
    local ast = _596_
  ...
  local function if_2a(ast, scope, parent, opts)
    ...
    if (#ast == 2) then
      ...
      for i = 2, (#ast - 1), 2 do
        local condchunk = {}
        local _605_ = compiler.compile1(ast[i], do_scope, condchunk, {nval = 1})
        local cond = _605_[1]
  ...
  local function remove_until_condition(bindings, ast)
    ...
    for i = (#bindings - 1), 3, -1 do
      local _611_0 = clause_3f(bindings[i])
      if ((_611_0 == false) or (_611_0 == nil)) then
      elseif (nil ~= _611_0) then
        local clause = _611_0
  ...
  local function compile_until(_3fcondition, scope, chunk)
    if _3fcondition then
      local _613_ = compiler.compile1(_3fcondition, scope, chunk, {nval = 1})
      local condition_lua = _613_[1]
  ...
  local function method_call(ast, scope, parent)
    ...
    for i = 4, #ast do
      ...
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _625_})
      local tbl_17_ = args
      local i_18_ = #tbl_17_
  ...
  SPECIALS.hashfn = function(ast, scope, parent)
    ...
    local f_scope = nil
    do
      local _635_0 = compiler["make-scope"](scope)
      _635_0["vararg"] = false
      _635_0["hashfn"] = true
      f_scope = _635_0
    end
  ...
  local function short_circuit_safe_3f(x, scope)
    ...
    elseif utils["list?"](x) then
      if utils["sym?"](x[1]) then
        local _641_0 = str1(x)
        if ((_641_0 == "fn") or (_641_0 == "hashfn") or (_641_0 == "let") or (_641_0 == "local") or (_641_0 == "var") or (_641_0 == "set") or (_641_0 == "tset") or (_641_0 == "if") or (_641_0 == "each") or (_641_0 == "for") or (_641_0 == "while") or (_641_0 == "do") or (_641_0 == "lua") or (_641_0 == "global")) then
          return false
        elseif (((_641_0 == "<") or (_641_0 == ">") or (_641_0 == "<=") or (_641_0 == ">=") or (_641_0 == "=") or (_641_0 == "not=") or (_641_0 == "~=")) and (comparator_special_type(x) == "binding")) then
          return false
        else
          local function _642_()
            return (1 ~= x[2])
          end
          if ((_641_0 == "pick-values") and _642_()) then
            return false
          else
  ...
  local function emit_short_circuit_if(ast, scope, parent, name, subast, accumulator, expr_string, setter)
    ...
    compiler.emit(parent, ("if %s then"):format(_653_()), subast)
    do
      local chunk = {}
  ...
  local function define_arithmetic_special(name, _3fzero_arity, _3funary_prefix, _3flua_name)
    local _659_
    do
      local _658_0 = (_3flua_name or name)
      local function _660_(...)
        return operator_special(_658_0, _3fzero_arity, _3funary_prefix, ...)
      end
      _659_ = _660_
    end
    SPECIALS[name] = _659_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _661_})
  ...
  SPECIALS.bnot = function(ast, scope, parent)
    compiler.assert((#ast == 2), "expected one argument", ast)
    local _669_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local value = _669_[1]
    if utils.root.options.useBitLib then
  ...
  local function native_comparator(op, _671_0, scope, parent)
    local _672_ = _671_0
    local _ = _672_[1]
    local lhs_ast = _672_[2]
    local rhs_ast = _672_[3]
    local _673_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _673_[1]
    local _674_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _674_[1]
  ...
  local function binding_comparator(op, chain_op, ast, scope, parent)
    ...
    return ("(" .. table.concat(_678_, chain) .. ")")
  end
  local function define_comparator_special(name, _3flua_op, _3fchain_op)
    do
      ...
      local function opfn(ast, scope, parent)
        ...
        local _680_0 = comparator_special_type(ast)
        if (_680_0 == "native") then
          return native_comparator(op, ast, scope, parent)
        elseif (_680_0 == "idempotent") then
          return idempotent_comparator(op, _3fchain_op, ast, scope, parent)
        elseif (_680_0 == "binding") then
  ...
  local function make_compiler_env(_3fast, _3fscope, _3fparent, _3fopts)
    local provided = nil
    do
      local _687_0 = (_3fopts or utils.root.options)
      if ((_G.type(_687_0) == "table") and (_687_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_687_0) == "table") and (nil ~= _687_0.compilerEnv)) then
        local compilerEnv = _687_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_687_0) == "table") and (nil ~= _687_0["compiler-env"])) then
        local compiler_env = _687_0["compiler-env"]
  ...
  local _695_ = _693_(...)
  local dirsep = _695_[1]
  local pathsep = _695_[2]
  local pathmark = _695_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function find_in_path(start, _3ftried_paths)
      local _698_0 = fullpath:match(pattern, start)
      if (nil ~= _698_0) then
        local path = _698_0
        local _699_0, _700_0 = try_path(path)
        if (nil ~= _699_0) then
          local filename = _699_0
          return filename
        elseif ((_699_0 == nil) and (nil ~= _700_0)) then
          local error = _700_0
          local function _702_()
            local _701_0 = (_3ftried_paths or {})
            table.insert(_701_0, error)
            return _701_0
          end
          return find_in_path((start + #path + 1), _702_())
        end
      else
        local _ = _698_0
  ...
  local function make_searcher(_3foptions)
    local function _707_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _708_0, _709_0 = search_module(module_name)
      if (nil ~= _708_0) then
        local filename = _708_0
        local function _710_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _710_, filename
      elseif ((_708_0 == nil) and (nil ~= _709_0)) then
        local error = _709_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _712_0 = utils.copy(utils.root.options)
      _712_0["module-name"] = module_name
      _712_0["env"] = "_COMPILER"
      _712_0["requireAsInclude"] = false
      _712_0["allowedGlobals"] = nil
      opts = _712_0
    end
    local _713_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _713_0) then
  ...
  local function lua_macro_searcher(module_name)
    local _719_0 = search_module(module_name, package.path)
    if (nil ~= _719_0) then
      local filename = _719_0
      local code = nil
      do
        ...
        code = close_handlers_10_(_G.xpcall(_721_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _723_0 = macro_searchers[n]
    if (nil ~= _723_0) then
      local f = _723_0
      local _724_0, _725_0 = f(modname)
      if ((nil ~= _724_0) and true) then
        local loader = _724_0
        local _3ffilename = _725_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      ...
      return {metadata = {setall = _728_}, view = view}
    end
  end
  local function _730_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _731_())
  end
  safe_require = _730_
  ...
  local function resolve_module_name(_732_0, _scope, _parent, opts)
    local _733_ = _732_0
    local second = _733_[2]
    local filename = _733_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_739_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _742_0, _743_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_742_0 == true) and (nil ~= _743_0)) then
        local modname = _743_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _747_()
        local _746_0 = search_module(mod)
        if (nil ~= _746_0) then
          local fennel_path = _746_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _747_())
  ...
  SPECIALS["pick-values"] = function(ast, scope, parent)
    ...
    if (1 == n) then
      local _751_ = compiler.compile1(vals, scope, parent, {nval = 1})
      local _752_ = _751_[1]
      local expr = _752_[1]
      return {("(" .. expr .. ")")}
    elseif (0 == n) then
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  ...
  local function declare_local(symbol, scope, ast, _3fvar_3f, _3fdeferred_scope_changes)
    ...
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _335_)
  ...
  local function symbol_to_expression(symbol, scope, _3freference_3f)
    ...
    local function _340_()
      local _339_0 = utils.root.options
      if (nil ~= _339_0) then
        _339_0 = _339_0.allowedGlobals
      end
      return _339_0
    end
    if (_340_() and not local_3f and scope.parent) then
  ...
  local function flatten_chunk(file_sourcemap, chunk, tab, depth)
    if chunk.leaf then
      local _350_ = utils["ast-source"](chunk.ast)
      local endline = _350_["endline"]
      local filename = _350_["filename"]
      local line = _350_["line"]
      ...
      do
        ...
        if (_352_0 == true) then
          tab0 = "  "
        elseif (_352_0 == false) then
          tab0 = ""
        elseif (nil ~= _352_0) then
          local tab1 = _352_0
          tab0 = tab1
        elseif (_352_0 == nil) then
          tab0 = ""
        else
        tab0 = nil
        end
  ...
  local function make_metadata()
    local function _362_(self, tgt, _3fkey)
      if self[tgt] then
        if (nil ~= _3fkey) then
    ...
    local function _365_(self, tgt, key, value)
      self[tgt] = (self[tgt] or {})
      self[tgt][key] = value
      return tgt
    end
    local function _366_(self, tgt, ...)
      local kv_len = select("#", ...)
      local kvs = {...}
      if ((kv_len % 2) ~= 0) then
    ...
    return setmetatable({}, {__index = {get = _362_, set = _365_, setall = _366_}, __mode = "k"})
  end
  ...
  local function handle_compile_opts(exprs, parent, opts, _3fast)
    ...
    if opts.target then
      ...
      emit(parent, string.format("%s = %s", opts.target, _376_()), _3fast)
    end
  ...
  local function find_macro(ast, scope)
    local macro_2a = nil
    do
      local _379_0 = utils["sym?"](ast[1])
      if (_379_0 ~= nil) then
        local _380_0 = tostring(_379_0)
        if (_380_0 ~= nil) then
          macro_2a = scope.macros[_380_0]
        else
          macro_2a = _380_0
        end
      else
  ...
  local function propagate_trace_info(_384_0, _index, node)
    local _385_ = _384_0
    local byteend = _385_["byteend"]
    local bytestart = _385_["bytestart"]
    local col = _385_["col"]
    local filename = _385_["filename"]
    local line = _385_["line"]
  ...
  local function macro_traceback(msg)
    if utils["debug-on?"]() then
      ...
      return table.concat(_393_, "\n")
    end
  end
  local function macroexpand_2a(ast, scope, _3fonce)
    local _396_0 = nil
    if utils["list?"](ast) then
      _396_0 = find_macro(ast, scope)
    else
    _396_0 = nil
    end
    if (_396_0 == false) then
      return ast
    elseif (nil ~= _396_0) then
      local macro_2a = _396_0
  ...
  local function callable_3f(_406_0, ctype, callee)
    local _407_ = _406_0
    local call_ast = _407_[1]
  ...
  local function compile_function_call(ast, scope, parent, opts, compile1, len)
    local _409_ = compile1(ast[1], scope, parent, {nval = 1})[1]
    local callee = _409_[1]
    local ctype = _409_["type"]
    local fargs = {}
    ...
    for i = 2, len do
      ...
      subexprs = compile1(ast[i], scope, parent, {nval = _410_})
  ...
  local function compile_varg(ast, scope, parent, opts)
    ...
    if scope.hashfn then
      ...
      _415_ = "unexpected vararg"
    end
    assert_compile(scope.vararg, _415_, ast)
  ...
  do
    ...
    view_opts = {["negative-infinity"] = "(-1/0)", ["negative-nan"] = _418_, infinity = "(1/0)", nan = _420_}
  end
  local function serialize_scalar(ast)
    local _422_0 = type(ast)
    if (_422_0 == "nil") then
      return "nil"
    elseif (_422_0 == "boolean") then
      return tostring(ast)
    elseif (_422_0 == "string") then
      return serialize_string(ast)
    elseif (_422_0 == "number") then
  ...
  local function compile_table(ast, scope, parent, opts, compile1)
    local function escape_key(k)
      if ((type(k) == "string") and utils["valid-lua-identifier?"](k)) then
        ...
        local _424_ = compile1(k, scope, parent, {nval = 1})
        local compiled = _424_[1]
    ...
    do
      ...
      for k in utils.stablepairs(ast) do
        local val_19_ = nil
        if not keys[k] then
          local _427_ = compile1(ast[k], scope, parent, {nval = 1})
          local v = _427_[1]
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    local opts0 = (opts or {})
    local _431_ = opts0
    local declaration = _431_["declaration"]
    local forceglobal = _431_["forceglobal"]
    local forceset = _431_["forceset"]
    local isvar = _431_["isvar"]
    local symtype = _431_["symtype"]
    ...
    local function getname(symbol, ast0)
      ...
      if declaration then
        ...
        if forceglobal then
          ...
          local _436_
          do
            local _435_0 = utils.root.options
            if (nil ~= _435_0) then
              _435_0 = _435_0.allowedGlobals
            end
            _436_ = _435_0
          end
          if _436_ then
    ...
    local function dynamic_set_target(_448_0)
      local _449_ = _448_0
      local _ = _449_[1]
      local target = _449_[2]
      local keys = {(table.unpack or unpack)(_449_, 3)}
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_454_, ", ")
    ...
    local function destructure_rest(s, k, left, destructure1)
      ...
      assert_compile((utils["sequence?"](left) and _456_()), "expected rest argument before last parameter", left)
    ...
    local function optimize_table_destructure_3f(left, right)
      ...
      return (utils["sequence?"](left) and utils["sequence?"](right) and _457_())
    end
    local function destructure_table(left, rightexprs, top_3f, destructure1, up1)
      ...
      if optimize_table_destructure_3f(left, rightexprs) then
        ...
        do
          local _458_0 = nil
          if top_3f then
            _458_0 = exprs1(compile1(from, scope, parent))
          else
            _458_0 = exprs1(rightexprs)
          end
          if (_458_0 == "") then
            right = "nil"
          elseif (nil ~= _458_0) then
            local right0 = _458_0
            right = right0
          else
          right = nil
  ...
  local function with_open_2a(_470_0, scope, parent, opts)
    local _471_ = _470_0
    local _ = _471_[1]
    local bindings = _471_[2]
    local ast = _471_
  ...
  local function compile_asts(asts, options)
    ...
    local _476_ = utils.root
    _476_["set-reset"](_476_)
  ...
  local function compile(from, _3fopts)
    local _479_0 = type(from)
    if (_479_0 == "userdata") then
      local function _480_()
        local _481_0 = from:read(1)
        if (nil ~= _481_0) then
          return _481_0:byte()
        else
          return _481_0
      ...
      return compile_stream(_480_, _3fopts)
    elseif (_479_0 == "function") then
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("\9%s:%d: in function %s", info.short_src, info.currentline, _486_())
  ...
  local function trace_adjust_msg(msg)
    local function _489_(...)
      local _490_0, _491_0, _492_0 = ...
      if ((nil ~= _490_0) and (nil ~= _491_0) and (nil ~= _492_0)) then
        local file = _490_0
        local line = _491_0
        local rest = _492_0
        local function _493_(...)
          local _494_0 = ...
          if ((_G.type(_494_0) == "table") and true and (nil ~= _494_0[2])) then
            local _ = _494_0[1]
            local newline = _494_0[2]
        ...
        local function _497_(...)
          local _496_0 = sourcemap
          if (nil ~= _496_0) then
            _496_0 = _496_0[("@" .. file)]
          end
          if (nil ~= _496_0) then
            _496_0 = _496_0[tonumber(line)]
          end
          return _496_0
        end
        return _493_(_497_(...))
    ...
    if ((_501_0 == "nil") or (_501_0 == "string")) then
      ...
      if ((msg:find("^%g+:%d+:%d+: Compile error:.*") or msg:find("^%g+:%d+:%d+: Parse error:.*")) and not utils["debug-on?"]("trace")) then
        ...
        for level = (_3fstart or 2), 999 do
          ...
          local _502_0 = (lua_getinfo and lua_getinfo(level, "Sln"))
          if (_502_0 == nil) then
            lines["done?"] = true
          elseif (nil ~= _502_0) then
            local info = _502_0
  ...
  local function do_quote(form, scope, parent, runtime_3f)
    ...
    elseif (type(form) == "table") then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s})", mixed_concat(quote_all(form), ", "), filename, _524_())
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _905_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _906_0 = type(v)
    if (_906_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_906_0 == "table") then
...
do
  ...
  local function partial_2a(f, ...)
    ...
    if (nil == bindings[1]) then
      return setmetatable({filename="src/fennel/macros.fnl", line=307, bytestart=11645, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=307}), setmetatable({_VARARG}, {filename="src/fennel/macros.fnl", line=307}), body}, getmetatable(list()))
    else
      return setmetatable({filename="src/fennel/macros.fnl", line=308, bytestart=11678, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=308}), bindings, setmetatable({filename="src/fennel/macros.fnl", line=309, bytestart=11706, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=309}), setmetatable({_VARARG}, {filename="src/fennel/macros.fnl", line=309}), body}, getmetatable(list()))}, getmetatable(list()))
    end
  end
  ...
  local function pick_args_2a(n, f)
    ...
    return setmetatable({filename="src/fennel/macros.fnl", line=318, bytestart=12045, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=318}), bindings, setmetatable({filename="src/fennel/macros.fnl", line=318, bytestart=12059, f, unpack(bindings)}, getmetatable(list()))}, getmetatable(list()))
  end
  ...
  local function lambda_2a(...)
    ...
    local function check_21(a)
      if _G["table?"](a) then
        ...
        if _38_ then
          return table.insert(args, check_position, setmetatable({filename="src/fennel/macros.fnl", line=339, bytestart=12994, sym('when', nil, {quoted=true, filename="src/fennel/macros.fnl", line=339}), setmetatable({filename="src/fennel/macros.fnl", line=339, bytestart=13000, sym('=', nil, {quoted=true, filename="src/fennel/macros.fnl", line=339}), sym('nil', nil, {quoted=true, filename="src/fennel/macros.fnl", line=339}), a}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=340, bytestart=13038, sym('_G.error', nil, {quoted=true, filename="src/fennel/macros.fnl", line=340}), ("Missing argument %s on %s:%s"):format(tostring(a), (a.filename or "unknown"), (a.line or "?")), 2}, getmetatable(list()))}, getmetatable(list())))
        end
      end
    end
    ...
    return setmetatable({filename="src/fennel/macros.fnl", line=348, bytestart=13438, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=348}), unpack(args)}, getmetatable(list()))
  end
  ...
  local function macro_2a(name, ...)
    ...
    local args = {...}
    return setmetatable({filename="src/fennel/macros.fnl", line=354, bytestart=13590, sym('macros', nil, {quoted=true, filename="src/fennel/macros.fnl", line=354}), setmetatable({[tostring(name)]=setmetatable({filename="src/fennel/macros.fnl", line=354, bytestart=13616, sym('fn', nil, {quoted=true, filename="src/fennel/macros.fnl", line=354}), unpack(args)}, getmetatable(list()))}, {filename="src/fennel/macros.fnl", line=354})}, getmetatable(list()))
  end
  ...
  local function macrodebug_2a(form, return_3f)
    ...
    return setmetatable({filename="src/fennel/macros.fnl", line=362, bytestart=14012, handle, view(macroexpand(form, _SCOPE), {["detect-cycles?"] = false})}, getmetatable(list()))
  end
  ...
  local function import_macros_2a(binding1, module_name1, ...)
    ...
    for i = 1, select("#", binding1, module_name1, ...), 2 do
      ...
      local expr = setmetatable({filename="src/fennel/macros.fnl", line=381, bytestart=15173, sym('import-macros', nil, {quoted=true, filename="src/fennel/macros.fnl", line=381}), modname}, getmetatable(list()))
      local filename = nil
  ...
  local function assert_repl_2a(condition, ...)
    ...
    return setmetatable({filename="src/fennel/macros.fnl", line=406, bytestart=16392, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=406}), setmetatable({sym('unpack_49_', nil, {filename="src/fennel/macros.fnl", line=406}), setmetatable({filename="src/fennel/macros.fnl", line=406, bytestart=16406, sym('or', nil, {quoted=true, filename="src/fennel/macros.fnl", line=406}), sym('table.unpack', nil, {quoted=true, filename="src/fennel/macros.fnl", line=406}), sym('_G.unpack', nil, {quoted=true, filename="src/fennel/macros.fnl", line=406})}, getmetatable(list())), sym('pack_51_', nil, {filename="src/fennel/macros.fnl", line=407}), setmetatable({filename="src/fennel/macros.fnl", line=407, bytestart=16449, sym('or', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407}), sym('table.pack', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407}), setmetatable({filename=nil, line=nil, bytestart=nil, sym('hashfn', nil, {quoted=true, filename=nil, line=nil}), setmetatable({filename="src/fennel/macros.fnl", line=407, bytestart=16465, sym('doto', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407}), setmetatable({sym('$...', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407})}, {filename="src/fennel/macros.fnl", line=407}), setmetatable({filename="src/fennel/macros.fnl", line=407, bytestart=16478, sym('tset', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407}), "n", setmetatable({filename="src/fennel/macros.fnl", line=407, bytestart=16487, sym('select', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407}), "#", sym('$...', nil, {quoted=true, filename="src/fennel/macros.fnl", line=407})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), sym('vals_50_', nil, {filename="src/fennel/macros.fnl", line=410}), setmetatable({filename="src/fennel/macros.fnl", line=410, bytestart=16660, sym('pack_51_', nil, {filename="src/fennel/macros.fnl", line=410}), condition, ...}, getmetatable(list())), sym('condition_52_', nil, {filename="src/fennel/macros.fnl", line=411}), setmetatable({filename="src/fennel/macros.fnl", line=411, bytestart=16704, sym('.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=411}), sym('vals_50_', nil, {filename="src/fennel/macros.fnl", line=411}), 1}, getmetatable(list())), sym('message_53_', nil, {filename="src/fennel/macros.fnl", line=412}), setmetatable({filename="src/fennel/macros.fnl", line=412, bytestart=16734, sym('or', nil, {quoted=true, filename="src/fennel/macros.fnl", line=412}), setmetatable({filename="src/fennel/macros.fnl", line=412, bytestart=16738, sym('.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=412}), sym('vals_50_', nil, {filename="src/fennel/macros.fnl", line=412}), 2}, getmetatable(list())), "assertion failed, entering repl."}, getmetatable(list()))}, {filename="src/fennel/macros.fnl", line=406}), setmetatable({filename="src/fennel/macros.fnl", line=413, bytestart=16792, sym('if', nil, {quoted=true, filename="src/fennel/macros.fnl", line=413}), setmetatable({filename="src/fennel/macros.fnl", line=413, bytestart=16796, sym('not', nil, {quoted=true, filename="src/fennel/macros.fnl", line=413}), sym('condition_52_', nil, {filename="src/fennel/macros.fnl", line=413})}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=414, bytestart=16822, sym('let', nil, {quoted=true, filename="src/fennel/macros.fnl", line=414}), setmetatable({sym('opts_54_', nil, {filename="src/fennel/macros.fnl", line=414}), setmetatable({["assert-repl?"]=true}, {filename="src/fennel/macros.fnl", line=414}), sym('fennel_55_', nil, {filename="src/fennel/macros.fnl", line=415}), setmetatable({filename="src/fennel/macros.fnl", line=415, bytestart=16878, sym('require', nil, {quoted=true, filename="src/fennel/macros.fnl", line=415}), _G["fennel-module-name"]()}, getmetatable(list())), sym('locals_56_', nil, {filename="src/fennel/macros.fnl", line=416}), add_locals(_G["get-scope"](), {})}, {filename="src/fennel/macros.fnl", line=414}), setmetatable({filename="src/fennel/macros.fnl", line=417, bytestart=16974, sym('set', nil, {quoted=true, filename="src/fennel/macros.fnl", line=417}), sym('opts_54_.message', nil, {filename="src/fennel/macros.fnl", line=417}), setmetatable({filename="src/fennel/macros.fnl", line=417, bytestart=16993, sym('fennel_55_.traceback', nil, {filename="src/fennel/macros.fnl", line=417}), sym('message_53_', nil, {filename="src/fennel/macros.fnl", line=417})}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=418, bytestart=17034, sym('each', nil, {quoted=true, filename="src/fennel/macros.fnl", line=418}), setmetatable({sym('k_57_', nil, {filename="src/fennel/macros.fnl", line=418}), sym('v_58_', nil, {filename="src/fennel/macros.fnl", line=418}), setmetatable({filename="src/fennel/macros.fnl", line=418, bytestart=17047, sym('pairs', nil, {quoted=true, filename="src/fennel/macros.fnl", line=418}), sym('_G', nil, {quoted=true, filename="src/fennel/macros.fnl", line=418})}, getmetatable(list()))}, {filename="src/fennel/macros.fnl", line=418}), setmetatable({filename="src/fennel/macros.fnl", line=419, bytestart=17072, sym('when', nil, {quoted=true, filename="src/fennel/macros.fnl", line=419}), setmetatable({filename="src/fennel/macros.fnl", line=419, bytestart=17078, sym('=', nil, {quoted=true, filename="src/fennel/macros.fnl", line=419}), sym('nil', nil, {quoted=true, filename="src/fennel/macros.fnl", line=419}), setmetatable({filename="src/fennel/macros.fnl", line=419, bytestart=17085, sym('.', nil, {quoted=true, filename="src/fennel/macros.fnl", line=419}), sym('locals_56_', nil, {filename="src/fennel/macros.fnl", line=419}), sym('k_57_', nil, {filename="src/fennel/macros.fnl", line=419})}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=419, bytestart=17101, sym('tset', nil, {quoted=true, filename="src/fennel/macros.fnl", line=419}), sym('locals_56_', nil, {filename="src/fennel/macros.fnl", line=419}), sym('k_57_', nil, {filename="src/fennel/macros.fnl", line=419}), sym('v_58_', nil, {filename="src/fennel/macros.fnl", line=419})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=420, bytestart=17135, sym('set', nil, {quoted=true, filename="src/fennel/macros.fnl", line=420}), sym('opts_54_.env', nil, {filename="src/fennel/macros.fnl", line=420}), sym('locals_56_', nil, {filename="src/fennel/macros.fnl", line=420})}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=421, bytestart=17170, sym('_G.assert', nil, {quoted=true, filename="src/fennel/macros.fnl", line=421}), setmetatable({filename="src/fennel/macros.fnl", line=421, bytestart=17181, sym('fennel_55_.repl', nil, {filename="src/fennel/macros.fnl", line=421}), sym('opts_54_', nil, {filename="src/fennel/macros.fnl", line=421})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list())), setmetatable({filename="src/fennel/macros.fnl", line=422, bytestart=17213, sym('values', nil, {quoted=true, filename="src/fennel/macros.fnl", line=422}), setmetatable({filename="src/fennel/macros.fnl", line=422, bytestart=17221, sym('unpack_49_', nil, {filename="src/fennel/macros.fnl", line=422}), sym('vals_50_', nil, {filename="src/fennel/macros.fnl", line=422}), 1, sym('vals_50_.n', nil, {filename="src/fennel/macros.fnl", line=422})}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))}, getmetatable(list()))
  end
  ...
  local function case_pattern(vals, pattern, unifications, opts, _3ftop)
    ...
    elseif (_G["list?"](pattern) and _G["sym?"](pattern[1], "=") and _G["sym?"](pattern[2])) then
      ...
      return setmetatable({filename="src/fennel/match.fnl", line=200, bytestart=9531, sym('=', nil, {quoted=true, filename="src/fennel/match.fnl", line=200}), val, bind}, getmetatable(list())), {}
    ...
    elseif (type(pattern) == "table") then
      ...
      return setmetatable({filename="src/fennel/match.fnl", line=232, bytestart=11268, sym('=', nil, {quoted=true, filename="src/fennel/match.fnl", line=232}), val, pattern}, getmetatable(list())), {}
    end
  end
  ...
  local function add_pre_bindings(out, pre_bindings)
    if pre_bindings then
      local tail = setmetatable({filename="src/fennel/match.fnl", line=241, bytestart=11666, sym('if', nil, {quoted=true, filename="src/fennel/match.fnl", line=241})}, getmetatable(list()))
      table.insert(out, true)
      table.insert(out, setmetatable({filename="src/fennel/match.fnl", line=243, bytestart=11731, sym('let', nil, {quoted=true, filename="src/fennel/match.fnl", line=243}), pre_bindings, tail}, getmetatable(list())))
      return tail
    else
      return out
    end
  ...
  local function case_condition(vals, clauses, match_3f, top_table_3f)
    local root = setmetatable({filename="src/fennel/match.fnl", line=252, bytestart=12072, sym('if', nil, {quoted=true, filename="src/fennel/match.fnl", line=252})}, getmetatable(list()))
    do
      local out = root
      for i = 1, #clauses, 2 do
        ...
        table.insert(out0, setmetatable({filename="src/fennel/match.fnl", line=265, bytestart=12809, sym('let', nil, {quoted=true, filename="src/fennel/match.fnl", line=265}), bindings, body}, getmetatable(list())))
        out = out0
      end
    end
    return root
  ...
  local function maybe_optimize_table(val, clauses)
    ...
    if _33_ then
      ...
      return setmetatable({filename="src/fennel/match.fnl", line=297, bytestart=14092, sym('values', nil, {quoted=true, filename="src/fennel/match.fnl", line=297}), unpack(val)}, getmetatable(list())), _35_()
    else
      return val, clauses
    end
  end
  ...
  local function case_impl(match_3f, init_val, ...)
    ...
    if skips_multiple_eval_protection_3f then
      ...
      return list(sym('let', nil, {quoted=true, filename="src/fennel/match.fnl", line=319}), {vals, val}, case_condition(vals, clauses, match_3f, _G["table?"](init_val)))
    end
  end
  ...
  local function case_try_step(how, expr, _else, pattern, body, ...)
    if ((nil == pattern) and (pattern == body)) then
      ...
      return setmetatable({filename="src/fennel/match.fnl", line=350, bytestart=16043, setmetatable({filename="src/fennel/match.fnl", line=350, bytestart=16044, sym('fn', nil, {quoted=true, filename="src/fennel/match.fnl", line=350}), setmetatable({_VARARG}, {filename="src/fennel/match.fnl", line=350}), setmetatable({filename="src/fennel/match.fnl", line=351, bytestart=16064, how, _VARARG, pattern, case_try_step(how, body, _else, ...), unpack(_else)}, getmetatable(list()))}, getmetatable(list())), expr}, getmetatable(list()))
    end
  end
  ...
  local function case_try_impl(how, expr, pattern, body, ...)
    ...
    if (_G["list?"](last) and _G["sym?"](last[1], "catch")) then
      ...
      catch = {sym('__43_', nil, {filename="src/fennel/match.fnl", line=361}), _VARARG}
    end
  ...
  local function case_try_2a(expr, pattern, body, ...)
    return case_try_impl(sym('case', nil, {quoted=true, filename="src/fennel/match.fnl", line=379}), expr, pattern, body, ...)
  end
  ...
  local function match_try_2a(expr, pattern, body, ...)
    return case_try_impl(sym('match', nil, {quoted=true, filename="src/fennel/match.fnl", line=392}), expr, pattern, body, ...)
  end
